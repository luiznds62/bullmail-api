...
export class BasicEmail {
              ...
              <tr>
                <td class="container">
                  <div class="content">
                    ...
                    <div class="footer">
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr><td class="content-block"><span class="apple-link">{{meta}}</span></td></tr>
                        <tr>
                          <td class="content-block powered-by">Powered by <a href="https://github.com/luiznds62">luiznds62</a>.</td>
                        </tr>
                      </table>
                    </div>
                  </div>
    ...
    compile() {
        const data = {
            ...
            textBeforeCTA: this.textBeforeCTA,
            textAfterCTA: this.textAfterCTA,
            ending: this.ending,
            meta: this.meta
        }
